 ...
 *
 */
public class LSIG extends BaseStruct implements CDHeader<Short, Integer> {
	...
	public LSIG(long data) {
		super(data, false);
	}
	public LSIG(long data, boolean owned) {
		super(data, owned);
	}
	...
	@Override
	public Integer getLength() { return _getDWORD(_Length); }
	@Override
	public void setLength(Integer length) { _setDWORD(_Length, length); }
